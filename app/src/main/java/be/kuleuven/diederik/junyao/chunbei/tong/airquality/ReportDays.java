...
public class ReportDays extends Fragment {
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_report_days,container,false);
        ...
        if(measurements.size()!=0){
            ...
            GraphView graph = (GraphView) view.findViewById(R.id.graphPM);
        ...
        if(measurements.size()!=0){
            ...
            GraphView graph = (GraphView) view.findViewById(R.id.graphCO);
